...
@Component({
  selector: 'app-validation-artwork-history',
  standalone: true,
  imports: [CommonModule, RouterLink, DateDisplayPipe],
  templateUrl: './validation-artwork-history.component.html',
  styleUrl: './validation-artwork-history.component.scss',
})
export class ValidationArtworkHistoryComponent {
